...
<style>
    .three-col{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1.25rem}.col-article{background:#fff;border:1px solid rgba(0,0,0,.08);border-radius:14px;box-shadow:0 2px 10px rgba(0,0,0,.04);overflow:hidden;transition:transform .15s,box-shadow .15s,border-color .15s;display:flex;flex-direction:column;height:100%}.col-article:hover{transform:translateY(-2px);box-shadow:0 8px 22px rgba(0,0,0,.08);border-color:rgba(0,0,0,.14)}.col-article img{width:100%;height:180px;object-fit:cover;display:block;background:#f3f3f3}.col-article .card-content{padding:1rem;display:flex;flex-direction:column;gap:.5rem;flex:1;min-height:0}.col-article h3{font-size:1.05rem;margin:0;line-height:1.3}.col-article p{margin:0;color:#555;font-size:.95rem;display:-webkit-box;-webkit-line-clamp:4;-webkit-box-orient:vertical;overflow:hidden}.col-article .meta{color:#777;font-size:.82rem;margin-top:auto}.article-status,.col-article .section-label{text-transform:uppercase;letter-spacing:.04em;font-size:.72rem}.col-article .actions{margin-top:.75rem;display:flex;justify-content:flex-end;gap:.5rem;flex-shrink:0}.col-article .section-label{display:inline-block;color:#666}.article-status{color:#b91c1c;font-weight:600}
</style>
